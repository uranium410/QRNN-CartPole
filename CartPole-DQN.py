...
class DQN:
    def __init__(self, learning_rate, state_size,action_size=2, hidden_size=10):
    ...
    def replay(self, memory, batch_size, gamma, targetQN ,state_size = 4):
...
#-------------Env Settings----------------#
    ...
    mainQN = DQN(state_size = state_size, hidden_size=hidden_size, learning_rate=learning_rate)
    targetQN = DQN(state_size = state_size, hidden_size=hidden_size, learning_rate=learning_rate)

    memory = Memory(max_size=memory_size)
    actor = Actor()

    f = open('results/DQN/result' + fileNumber + '.csv', 'w', newline="")
    writer = csv.writer(f)
